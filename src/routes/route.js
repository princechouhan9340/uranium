...
//     let inputPlayer = req.body

//     for ( let i = 0; i< players.length; i++){
//         if ( req.body.name === players[i].name){
//             res.send("error: player alrady exist")
//             break;
//         }
//     } 
//     players.push(inputPlayer);
//         res.send( { UpdateList:players} ) 
// });
...
router.post('/creaetUser', async function (req, res) {
...
router.get('/getcreaetUser', async function (req, res) {
